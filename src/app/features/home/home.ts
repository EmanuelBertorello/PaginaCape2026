...
export class HomeComponent implements OnInit, OnDestroy {
  ...
  readonly teamAbogados = [
    ...
    },
    {
      ...
      cargo: 'Abogada Asociada — Santa Fe',
      especialidad: 'Accidentes Laborales · Comisiones Médicas Santa Fe',
      bio: 'Egresada de la UNICEN (2019). Enfoque exclusivo en accidentes de trabajo y enfermedades profesionales. Interviene en etapa administrativa ante Comisiones Médicas y en instancia judicial. Matrícula en Pcia. de Buenos Aires y Rosario.',
