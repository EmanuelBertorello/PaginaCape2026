...
export const routes: Routes = [
  ...
  // === REDIRECTS — URLs alternativas ===
  { path: 'como-cobrar-art', redirectTo: '/como-cobrar-la-art', pathMatch: 'full' },
  { path: 'hernia-de-disco', redirectTo: '/hernia-de-disco-laboral', pathMatch: 'full' },
  { path: 'manguito-rotador', redirectTo: '/manguito-rotador-laboral', pathMatch: 'full' },
  { path: 'lesion-menisco-laboral', redirectTo: '/lesion-meniscos-laboral', pathMatch: 'full' },
  { path: 'tuenel-carpiano-laboral', redirectTo: '/tunel-carpiano-laboral', pathMatch: 'full' },
  { path: 'tunel-carpiano', redirectTo: '/tunel-carpiano-laboral', pathMatch: 'full' },
  { path: 'fractura-muneca', redirectTo: '/fractura-muneca-laboral', pathMatch: 'full' },
  ...
  { path: 'fractura-humero-laboral', loadComponent: () => import('./features/lesiones/lesion-page').then(m => m.LesionPageComponent) },
  { path: 'fractura-femur-laboral', loadComponent: () => import('./features/lesiones/lesion-page').then(m => m.LesionPageComponent) },
  { path: 'fractura-clavicula-laboral', loadComponent: () => import('./features/lesiones/lesion-page').then(m => m.LesionPageComponent) },
  { path: 'fractura-calcaneo-laboral', loadComponent: () => import('./features/lesiones/lesion-page').then(m => m.LesionPageComponent) },
  { path: 'fractura-rotula-laboral', loadComponent: () => import('./features/lesiones/lesion-page').then(m => m.LesionPageComponent) },
  { path: 'fractura-pelvis-laboral', loadComponent: () => import('./features/lesiones/lesion-page').then(m => m.LesionPageComponent) },
  { path: 'fractura-dedos-mano-laboral', loadComponent: () => import('./features/lesiones/lesion-page').then(m => m.LesionPageComponent) },
  { path: 'fractura-tobillo-laboral', loadComponent: () => import('./features/lesiones/lesion-page').then(m => m.LesionPageComponent) },
  { path: 'fractura-codo-laboral', loadComponent: () => import('./features/lesiones/lesion-page').then(m => m.LesionPageComponent) },
  { path: 'luxacion-hombro-laboral', loadComponent: () => import('./features/lesiones/lesion-page').then(m => m.LesionPageComponent) },
  { path: 'tendinitis-laboral', loadComponent: () => import('./features/lesiones/lesion-page').then(m => m.LesionPageComponent) },
  { path: 'fascitis-plantar-laboral', loadComponent: () => import('./features/lesiones/lesion-page').then(m => m.LesionPageComponent) },
  { path: 'varices-laborales', loadComponent: () => import('./features/lesiones/lesion-page').then(m => m.LesionPageComponent) },
  { path: 'lesion-medular-laboral', loadComponent: () => import('./features/lesiones/lesion-page').then(m => m.LesionPageComponent) },
  { path: 'amputacion-dedos-laboral', loadComponent: () => import('./features/lesiones/lesion-page').then(m => m.LesionPageComponent) },
  { path: 'amputacion-mano-laboral', loadComponent: () => import('./features/lesiones/lesion-page').then(m => m.LesionPageComponent) },
  { path: 'amputacion-pie-laboral', loadComponent: () => import('./features/lesiones/lesion-page').then(m => m.LesionPageComponent) },
  { path: 'aplastamiento-miembros-laboral', loadComponent: () => import('./features/lesiones/lesion-page').then(m => m.LesionPageComponent) },
  { path: 'caida-de-altura-laboral', loadComponent: () => import('./features/lesiones/lesion-page').then(m => m.LesionPageComponent) },
  { path: 'perdida-vision-laboral', loadComponent: () => import('./features/lesiones/lesion-page').then(m => m.LesionPageComponent) },
  { path: 'estres-laboral', loadComponent: () => import('./features/lesiones/lesion-page').then(m => m.LesionPageComponent) },
  { path: 'incapacidad-psicologica-laboral', loadComponent: () => import('./features/lesiones/lesion-page').then(m => m.LesionPageComponent) },
  { path: 'acoso-laboral', loadComponent: () => import('./features/lesiones/lesion-page').then(m => m.LesionPageComponent) },
  { path: 'dano-estetico-laboral', loadComponent: () => import('./features/lesiones/lesion-page').then(m => m.LesionPageComponent) },
  { path: 'infarto-laboral', loadComponent: () => import('./features/lesiones/lesion-page').then(m => m.LesionPageComponent) },
  { path: 'acv-laboral', loadComponent: () => import('./features/lesiones/lesion-page').then(m => m.LesionPageComponent) },
  { path: 'intoxicacion-laboral', loadComponent: () => import('./features/lesiones/lesion-page').then(m => m.LesionPageComponent) },
  { path: 'intoxicacion-quimicos-laboral', loadComponent: () => import('./features/lesiones/lesion-page').then(m => m.LesionPageComponent) },

  // === 15 NUEVAS LANDINGS DE LESIONES ===
  { path: 'fractura-tibia-perone-laboral', loadComponent: () => import('./features/lesiones/lesion-page').then(m => m.LesionPageComponent) },
  { path: 'fractura-columna-laboral', loadComponent: () => import('./features/lesiones/lesion-page').then(m => m.LesionPageComponent) },
  { path: 'fractura-cadera-laboral', loadComponent: () => import('./features/lesiones/lesion-page').then(m => m.LesionPageComponent) },
  { path: 'fractura-hombro-laboral', loadComponent: () => import('./features/lesiones/lesion-page').then(m => m.LesionPageComponent) },
  { path: 'aplastamiento-mano-laboral', loadComponent: () => import('./features/lesiones/lesion-page').then(m => m.LesionPageComponent) },
  { path: 'amputacion-laboral', loadComponent: () => import('./features/lesiones/lesion-page').then(m => m.LesionPageComponent) },
  { path: 'lesion-ligamentos-rodilla-laboral', loadComponent: () => import('./features/lesiones/lesion-page').then(m => m.LesionPageComponent) },
  { path: 'quemaduras-laborales', loadComponent: () => import('./features/lesiones/lesion-page').then(m => m.LesionPageComponent) },
  { path: 'traumatismo-craneoencefalico-laboral', loadComponent: () => import('./features/lesiones/lesion-page').then(m => m.LesionPageComponent) },
  { path: 'cervicalgia-laboral', loadComponent: () => import('./features/lesiones/lesion-page').then(m => m.LesionPageComponent) },
  { path: 'epicondilitis-laboral', loadComponent: () => import('./features/lesiones/lesion-page').then(m => m.LesionPageComponent) },
  { path: 'hombro-doloroso-laboral', loadComponent: () => import('./features/lesiones/lesion-page').then(m => m.LesionPageComponent) },
  { path: 'esguince-tobillo-laboral', loadComponent: () => import('./features/lesiones/lesion-page').then(m => m.LesionPageComponent) },
  { path: 'hernia-inguinal-laboral', loadComponent: () => import('./features/lesiones/lesion-page').then(m => m.LesionPageComponent) },
  { path: 'fractura-costillas-laboral', loadComponent: () => import('./features/lesiones/lesion-page').then(m => m.LesionPageComponent) },
  { path: 'silicosis-laboral', loadComponent: () => import('./features/lesiones/lesion-page').then(m => m.LesionPageComponent) },
